...
public class WebQACustomField  implements java.io.Serializable {
     ...
     */
    public void setFldValue(java.lang.String fldValue) throws UnsupportedEncodingException {
    	/*if (!"".equals(Utility.checkNull(fldValue))) {
			this.fldValue = URLEncoder.encode(fldValue, "UTF-8");
		} else {
			this.fldValue = fldValue;
		}*/
