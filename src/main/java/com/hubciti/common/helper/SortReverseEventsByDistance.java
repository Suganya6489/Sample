...
public class SortReverseEventsByDistance implements Comparator<EventDetails> {
	/**
	 * Logger instance.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(SortReverseEventsByDistance.class.getName());
	...
	public int compare(EventDetails o1, EventDetails o2) {
		...
		try {
			...
			LOG.error("ParseException in SortReverseEventsByDistance : Exception : " + e.getMessage());
		}
		return iCategory;
	}
}
