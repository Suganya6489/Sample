 ...
 * @author Kumar D
 */
public class SortBandByCategory implements Comparator<CategoryInfo> {
	/**
	 * Logger instance.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(SortBandByCategory.class.getName());
	...
	public int compare(CategoryInfo o1, CategoryInfo o2) {
		...
		try {
			...
			LOG.error("ParseException in SortBandByCategory : Exception : " + e.getMessage());
		}
		return iCategory;
	}
}
